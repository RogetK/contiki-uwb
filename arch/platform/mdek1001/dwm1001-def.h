...
#define SPIM2_SCK_PIN   4  // SPI clock GPIO pin number.
#define SPIM2_MOSI_PIN  6  // SPI Master Out Slave In GPIO pin number.
#define SPIM2_MISO_PIN  7  // SPI Master In Slave Out GPIO pin number.
